...
const Login = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-sm w-full space-y-8 shadow-[0_5px_60px_-15px_rgba(0,0,0,0.3)] p-10 rounded-[20px] relative">
                    <div className='login-circle rounded-full bg-slate-500 flex place-content-center'>
                        <img src='../src/resources/logo-icon.svg' className='logoIcon'></img>
                    </div>
                <div>
